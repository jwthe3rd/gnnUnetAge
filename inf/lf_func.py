...
def calc_dist_inlet_outlet(polyMesh_dir,list_boundaries):
    ...
    min_in, max_in, min_out, max_out =  min(dist_inlet_raw),max(dist_inlet_raw), min(dist_outlet_raw), max(dist_outlet_raw)

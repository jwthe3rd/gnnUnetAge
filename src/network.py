...
class AgeNet(nn.Module):
    ...
    def __init__(self, args,conv_act, pool_act):
        ...
        self.bottom_lin = nn.Linear(self.bottom_conv_indim, self.bottom_conv_indim // 2, self.conv_act, self.batch_norm)#bigConv(self.bottom_conv_indim, self.bottom_conv_indim // 2, self.conv_act, 0.2, self.batch_norm)
        self.bottom_lin2 = nn.Linear(self.bottom_conv_indim // 2, args.lat_dim, self.conv_act, 0.2, self.batch_norm)#bigConv(self.bottom_conv_indim // 2, args.lat_dim, self.conv_act, 0.2, self.batch_norm)
